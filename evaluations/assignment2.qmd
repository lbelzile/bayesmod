...
1. Using a variant of Metropolis--Hastings algorithm, obtain posterior draws for the parameters $$(\alpha_1, \alpha_2, \gamma, \delta_1, \ldots, \delta_{92}, \tau^2).$$ Perform enough simulations to obtain an effective sample size of 1000 for each parameter and report these effective sample sizes.

...
\begin{align*}
\mathsf{E}(Y_i; \lambda_0, \lambda_1) = \exp(\beta_0 + \beta_1\texttt{limit}_i) = \begin{cases} \lambda_0 & \texttt{limit}_i=0 \\ \lambda_1 & \texttt{limit}_i=1.
\end{align*}

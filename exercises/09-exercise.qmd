...
Consider the Bernoulli sample of size $n$ with $y$ successes and a $\mathsf{beta}(1/2, 1/2)$ conjugate prior. Compute the Laplace approximation to the posterior mean for samples of size $n=10, 20, 50, 100$ and $y/n \in \{0, 0.1, 0.25, 0.5\}$.

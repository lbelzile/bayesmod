...
The **marginal density** $f_{\boldsymbol{X}_{1:k}}(\boldsymbol{x}_{1:k})$ continuous subvector $\boldsymbol{X}_{1:k}=(X_1, \ldots, X_k)^\top$ of $\boldsymbol{X} = (X_1, \ldots, X_d)^\top$ is
\begin{align*}
...
\begin{align*}
\mathsf{E}(\mathbf{A}\boldsymbol{Y} + \boldsymbol{b}) &= \mathbf{A}\mathsf{E}(\boldsymbol{Y}) + \boldsymbol{b},\\
\mathsf{Va}(\mathbf{A}\boldsymbol{Y} + \boldsymbol{b}) &= \mathbf{A}\mathsf{Va}(\boldsymbol{Y})\mathbf{A}^\top.
\end{align*}
...
By the laws of iterated expectation and iterated variance,
\begin{align*}
...
\begin{align*}
 ...
 \boldsymbol{Q} = \begin{pmatrix} \boldsymbol{Q}_{11} & \boldsymbol{Q}_{12}\\ \boldsymbol{Q}_{21} & \boldsymbol{Q}_{22}\end{pmatrix},
\end{align*}
...
\begin{align*}
\boldsymbol{Y}_1 \mid \boldsymbol{Y}_2 =\boldsymbol{y}_2 &\sim \mathsf{Gauss}_k\left\{\boldsymbol{\mu}_1-\boldsymbol{Q}_{11}^{-1}\boldsymbol{Q}_{12}(\boldsymbol{y}_2-\boldsymbol{\mu}_2), \boldsymbol{Q}^{-1}_{11}\right\}.
\end{align*}
...
$$U(\boldsymbol{\theta}; \boldsymbol{y}) = \frac{\partial \ell(\boldsymbol{\theta}; \boldsymbol{y})}{ \partial \boldsymbol{\theta}}.$$
...
- $g(x)=x$ (mean)
- $g(x) = \mathsf{I}(x \in A)$: probability of event,  since $\mathsf{E}\{\mathsf{I}(X \in A)\} = \Pr(X \in A)$
- etc.

...
## Stipulating inputs on standardized scales
...
for each posterior draw $\boldsymbol{\theta}_b,$ we can use importance sampling [@Kallioinen:2023] to estimate this without rerunning the sampling.

This is implemented in the **R** package [`priorsense`](https://n-kall.github.io/priorsense/index.html) [@Kallioinen:2026].

 proposes using power scaling via an importance sampling scheme.
